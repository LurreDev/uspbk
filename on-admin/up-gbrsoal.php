          ...
          <div class="row">
            ...
            <div id="mar" class="col-xs-12">
                <?php if($message) echo "<p>$message</p>"; ?>
                    ...
                    {
                    $gambarsoal ="<img src='images/$data' width=200pk height=auto >";
                    ...
                    $dok = $tanda[1];
                    	...
                    	$co="<img src='images/$data' width=200pk height=auto >";
                    	} elseif ($dok == "mp3" OR $dok == "ogg") {
                    	$co="<audio src='images/$data' controls ></audio>";
                    	}
                    echo "
                    <tr class='list'>
                    <td><a href='".images."/".$data."' target='new_tab'>".$file.".".$dok."</a></td>
                    <td>".$co."</td>
                    <td>".$tgl."</td>
                    <td>".$jam."</td>
                    <td class='hapus'><a style='font-decoration:none;color:#222;' href='dropgbrsoal.php?file=".images."/".$data."'><button type='button' class='btn btn-danger'><i class='fa fa-trash-o'></i> Hapus</button></a></td>
                    ";
                    echo "</tr>";
                    }
                    ?>
