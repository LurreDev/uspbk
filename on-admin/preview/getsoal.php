...
$query = mysqli_query ($konek, "SELECT * FROM soal WHERE kodemapel='$mapel' and jenissoal='$jenis' and kodesoal='$kode' ORDER by $acak");
						if($query == false){
						die ("Terjadi Kesalahan : ". mysqli_error($konek));
						$i=1;
						}
						...
						if(!$ar['gambarsoal']=='')
				        {
					    $gambarsoal = "<img src='../images/$ar[gambarsoal]' alt='Nature' class='responsive' align=center style='max-width:500pk;height:auto' ><br>";
				        }
				        else
				        {
					    $gambarsoal = "";
					    ...
					    if(!$ar['gambar_a']=='')
				        {
					    $gambar_a = "<img src='../images/$ar[gambar_a]' class='responsive' align=center style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_a = "";
				        ...
				        if(!$ar['gambar_b']=='')
				        {
					    $gambar_b = "<img src='../images/$ar[gambar_b]' class='responsive' align=center style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_b = "";
				        ...
				        if(!$ar['gambar_c']=='')
				        {
					    $gambar_c = "<img src='../images/$ar[gambar_c]' class='responsive'  align=center style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_c = "";
				        ...
				        if(!$ar['gambar_d']=='')
				        {
					    $gambar_d = "<img src='../images/$ar[gambar_d]' class='responsive' align=centerstyle='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_d = "";
					    ...
					    if(!$ar['gambar_e']=='')
				        {
					    $gambar_e = "<img src='../images/$ar[gambar_e]' class='responsive' align=centerstyle='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_e = "";
