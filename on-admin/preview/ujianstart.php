    ...
    <div class="group">
        ...
        <?php }?>
    	    <div class="right">
				...
				<tr><td><span class="log"><a href="../index.php"><h5>Back to Home <i class="fa fa-home"></i></a></h5></span></td></tr>
			    </table>
            </div>
    </div>
</header>
			...
			<div class="modal-body">
				<div class="container">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                      ...
                      <a href="../index.php"><button id="yakin" class='btn btn-success'><i class="fa fa-home"></i> Back to Home</button></a>
					  <br><br>
					  </div><!-- /.box-body -->
				</div><!-- /.box -->
            </div><!-- /.modal body -->
