       ...
       <br>
                ...
                <div class="page">
				            <table width="100%" class="kartu">
                				<tr>
                					...
                					<td align="center" style="font-weight:bold; padding: 4px;"><h3>DAFTAR HADIR PESERTA UJIAN SATUAN PENDIDIKAN BERBASIS KOMPUTER <br> <u><?php echo $xx['n_sekolah'];?> <?php echo date ('Y') ?></u></h3></td>
			...
			<table class="table" width="100%">
				<tr style="height:30px">
					...
					<td id="garis" width="*"><?php echo $ar[nama]; ?></td>
