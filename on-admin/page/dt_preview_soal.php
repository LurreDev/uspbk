    ...
    <hr class="style2">
                <tbody>
					...
					$qu = mysqli_query ($konek, "SELECT * FROM ujian where kodesoal='$kode'");
				        ...
				        if(!$ar['gambar_c']=='')
				        {
					    $gambar_c = "<img src='images/$ar[gambar_c]' style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_c = "";
				        ...
				        if(!$ar['gambar_d']=='')
				        {
					    $gambar_d = "<img src='images/$ar[gambar_d]' style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_d = "";
				        ...
				        if(!$ar['gambar_e']=='')
				        {
					    $gambar_e = "<img src='images/$ar[gambar_e]' style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_e = "";
					    ...
					    $pilihan = "<br>
                                    ...
                                    &emsp;<p>c. &emsp;$pilihan_c $gambar_c</p> 
                                    &emsp;<p>d. &emsp;$pilihan_d $gambar_d</p>   
    								&emsp;<p>e. &emsp;$pilihan_e $gambar_e  &emsp;<i class='fa fa-check-circle' style='font-size:20px;color:green'></i></p>";
				        }
							echo "
