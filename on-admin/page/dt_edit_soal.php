...
<button id="clot" type="button" class="btn btn-success" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Tambah Butir Soal</button>
						...
						<form action="page/butirsoal_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							...
							<div class="form-group">
								...
								<label>Pilihan A</label>
									...
									<div class="input-group">
										<textarea name="pilihan1" cols="90" class="form-control"></textarea>
									</div>
									<div class="input-group">
										<div class="input-group-addon">
							...
							<div class="form-group">
								...
								<label>Pilihan B</label>
									...
									<div class="input-group">
										<textarea name="pilihan2" cols="90" class="form-control" ></textarea>
									</div>
									<div class="input-group">
										<div class="input-group-addon">
							...
							<div class="form-group">
								...
								<label>Pilihan C</label>
									...
									<div class="input-group">
										<textarea name="pilihan3" cols="90" class="form-control" ></textarea>
									</div>
									<div class="input-group">
										<div class="input-group-addon">
							...
							<div class="form-group">
								...
								<label>Pilihan D</label>
									...
									<div class="input-group">
										<textarea name="pilihan4" cols="90" class="form-control" ></textarea>
									</div>
									<div class="input-group">
										<div class="input-group-addon">
							...
							<div class="form-group">
								...
								<label>Pilihan E</label>
									...
									<div class="input-group">
										<textarea name="pilihan5" cols="90" class="form-control" ></textarea>
									</div>
									<div class="input-group">
										<div class="input-group-addon">
		...
		<thead>
                ...
                <tbody>
					<?php
				        ...
				        if(!$ar['audio']=='')
				        {
					    $audio = "<audio src='images/$ar[audio]' controls controlsList='nodownload'></audio><br>";
				        }
				        else
				        {
					    $audio = "";
						 ...
						 if(!$ar['gambarsoal']=='')
				        {
					    $gambarsoal = "<img src='images/$ar[gambarsoal]' align=center width=200pk height=auto ><br>";
				        }
				        else
				        {
					    $gambarsoal = "";
				        ...
				        if(!$ar['gambar_a']=='')
				        {
					    $gambar_a = "<img src='images/$ar[gambar_a]' align=center width=200pk height=auto >";
				        }
				        else
				        {
					    $gambar_a = "";
				        ...
				        if(!$ar['gambar_b']=='')
				        {
					    $gambar_b = "<img src='images/$ar[gambar_b]' align=center width=200pk height=auto >";
				        }
				        else
				        {
					    $gambar_b = "";
				        ...
				        if(!$ar['gambar_c']=='')
				        {
					    $gambar_c = "<img src='images/$ar[gambar_c]' align=center width=200pk height=auto >";
				        }
				        else
				        {
					    $gambar_c = "";
				        ...
				        if(!$ar['gambar_d']=='')
				        {
					    $gambar_d = "<img src='images/$ar[gambar_d]' align=center width=200pk height=auto >";
				        }
				        else
				        {
					    $gambar_d = "";
				        ...
				        if(!$ar['gambar_e']=='')
				        {
					    $gambar_e = "<img src='images/$ar[gambar_e]' align=center width=200pk height=auto >";
				        }
				        else
				        {
					    $gambar_e = "";
					    ...
					    $pilihan_e = "";
							...
							echo "
								<tr>
									...
									<td align=center>$pilihan_e$gambar_e</td>
