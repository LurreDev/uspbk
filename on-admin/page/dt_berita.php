    ...
    <button id="ti" class="btn btn-warning" float:right onclick="printDiv('printableArea')"><i class="fa fa-print"></i> Cetak <?php echo $_POST['ruang']; ?> | Sesi <?php echo $_POST['sesi']; ?></button>
                ...
                <div class="page">
				            <table width="100%" class="kartu">
                				<tr>
                					...
                					<td align="center" style="font-weight:bold; padding: 4px;"><h3>BERITA ACARA UJIAN<br> <u><?php echo $xx['n_sekolah'];?> <?php echo date ('Y') ?></u></h3></td>
		...
		<table class="cetakan">
			...
			<tr>
				...
				<td valign="bottom"><span style="width:170px">Moch.Hasan Baihaqi,SH</span></td>
			...
			<tr>
				...
				<td valign="bottom"><span style="width:170px">Arib Adi Mulja,S.Kom.,M.Si.,Gr</span></td>
