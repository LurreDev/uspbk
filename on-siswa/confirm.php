...
<div class="col-md-6 col-md-offset-3 login-wrapper" style="float:inherit">
    <div class="panel panel-default">
        ...
        <form action="mulai.php" method="post">    
                ...
                <div id="garis" class="list-group-item">
                    ...
                    <p class="list-group-item-text"><?php echo $waktu; ?> MENIT</p>
                </div>
 ...
 <input id="kelas" name="kelas" type="hidden" value="<?php echo "$kelas"; ?>">                    
        ...
        <?php if (!empty($_GET['token'])) { echo "&emsp;<a id='ok' href='ujian.php'><button id='ok' type='button' class='btn btn-primary btn-xs' data-toggle='modal'><i class='fa fa-arrow-left'></i> BACK</button></a> <h5 style='color:red;'>&emsp;Token <b>SALAH</b>, Silahkan <b>tanya pengawas !!</b></h5>"; }
        ?>
