...
$query = mysqli_query ($konek, "SELECT * FROM soal CROSS JOIN jawaban USING (kodesoal) WHERE nis='$username' ORDER by $acak");
						if($query == false){
						die ("Terjadi Kesalahan : ". mysqli_error($konek));
						$i=1;
						}
						...
						if(!$ar['gambarsoal']=='')
				        {
					    $gambarsoal = "<img src='../on-admin/images/$ar[gambarsoal]' alt='Nature' class='responsive' align=center style='max-width:500pk;height:auto' ><br>";
				        }
				        else
				        {
					    $gambarsoal = "";
					    ...
					    if(!$ar['gambar_a']=='')
				        {
					    $gambar_a = "<img src='../on-admin/images/$ar[gambar_a]' class='responsive' align=center style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_a = "";
				        ...
				        if(!$ar['gambar_b']=='')
				        {
					    $gambar_b = "<img src='../on-admin/images/$ar[gambar_b]' class='responsive' align=center style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_b = "";
				        ...
				        if(!$ar['gambar_c']=='')
				        {
					    $gambar_c = "<img src='../on-admin/images/$ar[gambar_c]' class='responsive'  align=center style='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_c = "";
				        ...
				        if(!$ar['gambar_d']=='')
				        {
					    $gambar_d = "<img src='../on-admin/images/$ar[gambar_d]' class='responsive' align=centerstyle='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_d = "";
					    ...
					    $pilihan_d = "";
					     ...
					     if(!$ar['gambar_e']=='')
				        {
					    $gambar_e = "<img src='../on-admin/images/$ar[gambar_e]' class='responsive' align=centerstyle='max-width:300pk;height:auto' >";
				        }
				        else
				        {
					    $gambar_e = "";
...
<div class="soalnye cls<?php echo $i; ?>">
                ...
                <button id="nomer" type="button" class="soal btn-default"><b><?php echo "$i"; ?></b></button></br></br>
                    ...
                    <input hidden name='jawabansiswa<?php echo "$ar[nomersoal]"; ?>' id='x<?php echo "$i"; ?>' type='radio' value='X' checked="checked" >
                    <label class="custom-radio-button">
                        <div class="col-xs-12">
                                <input type="radio" name='jawabansiswa<?php echo "$ar[nomersoal]"; ?>' id='jawabansiswaA<?php echo "$i"; ?>' value="A"<?php echo ($ar[jawabansiswa][$ar[nomersoal]-1]=='A')?'checked="checked"':'' ?>/> 
                    ...
                    <label class="custom-radio-button">
                        <div class="col-xs-12">
                                <input type="radio" name='jawabansiswa<?php echo "$ar[nomersoal]"; ?>' id='jawabansiswaB<?php echo "$i"; ?>' value="B"<?php echo ($ar[jawabansiswa][$ar[nomersoal]-1]=='B')?'checked="checked"':'' ?>/> 
                                    <span class="helping-el"></span>
                    ...
                    <label class="custom-radio-button">
                        <div class="col-xs-12">
                                <input type="radio" name='jawabansiswa<?php echo "$ar[nomersoal]"; ?>' id='jawabansiswaC<?php echo "$i"; ?>' value="C"<?php echo ($ar[jawabansiswa][$ar[nomersoal]-1]=='C')?'checked="checked"':'' ?>/> 
                                    <span class="helping-el"></span>
                    ...
                    <label class="custom-radio-button">
                        <div class="col-xs-12">
                                <input type="radio" name='jawabansiswa<?php echo "$ar[nomersoal]"; ?>' id='jawabansiswaD<?php echo "$i"; ?>' value="D"<?php echo ($ar[jawabansiswa][$ar[nomersoal]-1]=='D')?'checked="checked"':'' ?>/> 
                                    <span class="helping-el"></span>
                    ...
                    <div class="col-xs-12">
                                <input type="radio" name='jawabansiswa<?php echo "$ar[nomersoal]"; ?>' id='jawabansiswaE<?php echo "$i"; ?>' value="E"<?php echo ($ar[jawabansiswa][$ar[nomersoal]-1]=='E')?'checked="checked"':'' ?>/> 
                                    <span class="helping-el"></span>
